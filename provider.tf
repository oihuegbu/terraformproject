...
data "aws_ssm_parameter" "unicbi_access_key" {
...
provider "aws" {
  ...
  access_key = data.aws_ssm_parameter.unicbi_access_key.value
  secret_key = data.aws_ssm_parameter.unicbi_secret_key.value
